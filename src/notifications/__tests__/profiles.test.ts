...
const PROFILE_ENV_KEY = "OMCP_NOTIFY_PROFILE";

function clearProfileEnv(): void {
  delete process.env[PROFILE_ENV_KEY];
  delete process.env.OMCP_DISCORD_NOTIFIER_BOT_TOKEN;
  delete process.env.OMCP_DISCORD_NOTIFIER_CHANNEL;
  delete process.env.OMCP_DISCORD_WEBHOOK_URL;
  delete process.env.OMCP_DISCORD_MENTION;
  delete process.env.OMCP_TELEGRAM_BOT_TOKEN;
  delete process.env.OMCP_TELEGRAM_CHAT_ID;
  delete process.env.OMCP_SLACK_WEBHOOK_URL;
}
...
describe("resolveProfileConfig", () => {
  ...
  it("resolves OMCP_NOTIFY_PROFILE env var when no explicit name", () => {
...
describe("getActiveProfileName", () => {
  ...
  it("returns env var value when OMCP_NOTIFY_PROFILE is set", async () => {
...
describe("profile edge cases", () => {
  ...
  it("env vars merge into selected profile config", async () => {
    process.env.OMCP_TELEGRAM_BOT_TOKEN = "env-token";
    process.env.OMCP_TELEGRAM_CHAT_ID = "env-chat";
