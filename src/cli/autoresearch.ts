...
export const AUTORESEARCH_HELP = `omcp autoresearch - Hard-deprecated legacy command surface
...
Deprecated legacy forms (all fail intentionally):
  ...
  omcp autoresearch init [--topic T] [--evaluator CMD] [--keep-policy P] [--slug S]
  omcp autoresearch run <mission-dir> [codex-args...]
  omcp autoresearch <mission-dir> [codex-args...]
  omcp autoresearch --resume <run-id> [codex-args...]

Migration:
  - Use \`$deep-interview --autoresearch\` to clarify the mission and write canonical artifacts under \`.omcp/specs/autoresearch-{slug}/\`
