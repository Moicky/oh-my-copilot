...
export type NativeProduct = 'omcp-explore-harness' | 'omcp-sparkshell';
...
const NATIVE_AUTO_FETCH_ENV = 'OMCP_NATIVE_AUTO_FETCH';
const NATIVE_MANIFEST_URL_ENV = 'OMCP_NATIVE_MANIFEST_URL';
const NATIVE_RELEASE_BASE_URL_ENV = 'OMCP_NATIVE_RELEASE_BASE_URL';
const NATIVE_CACHE_DIR_ENV = 'OMCP_NATIVE_CACHE_DIR';
export const EXPLORE_BIN_ENV = 'OMCP_EXPLORE_BIN';
export const SPARKSHELL_BIN_ENV = 'OMCP_SPARKSHELL_BIN';
