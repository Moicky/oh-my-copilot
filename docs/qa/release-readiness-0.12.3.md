...
`0.12.3` is a tight follow-up to `0.12.2` that ships PR [#1364](https://github.com/Yeachan-Heo/oh-my-copilot/pull/1364) (`$team` prompt-routing correctness and duplicate team launch teardown), which was intended for `0.12.2` but finished its conflict resolution after the `0.12.2` cut, plus release-collateral alignment.
