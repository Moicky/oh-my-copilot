...
| Version smoke | `node bin/omcp.js version` | PASS (`oh-my-copilot v0.8.4`) |
| Doctor smoke | `node bin/omcp.js doctor` | PASS (`9 passed, 0 warnings, 0 failed`) |
...
- This is a focused patch release centered on `omcp setup` refresh behavior and managed model upgrade prompting.
