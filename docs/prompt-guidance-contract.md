...
This document explains the **behavioral prompt contract** introduced by the GPT-5.4 guidance rollout in [#608](https://github.com/Moicky/oh-my-copilot/issues/608) and expanded in [#611](https://github.com/Moicky/oh-my-copilot/pull/611) and [#612](https://github.com/Moicky/oh-my-copilot/pull/612).
...
Issue [#615](https://github.com/Moicky/oh-my-copilot/issues/615) uses examples like `src/prompts/role-planner.ts`, but the current prompt sources in this repository live in **`prompts/*.md`**, then get installed to `~/.codex/prompts/`.
...
- Implementation issue: [#608](https://github.com/Moicky/oh-my-copilot/issues/608)
- Documentation issue: [#615](https://github.com/Moicky/oh-my-copilot/issues/615)
