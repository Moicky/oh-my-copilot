# Ralph Upstream → OMCP Parity Matrix

Baseline source: `docs/reference/ralph-upstream-baseline.md` (`165c3688bfde275560c001a0de4c7563cf82ad69`)

| Rule ID | Upstream semantic rule | OMCP implementation point(s) | Status | Verification reference |
|---|---|---|---|---|
...
- **adopted**: behavior implemented directly in OMCP runtime.
- **adapted**: behavior implemented with OMCP-specific contract/scope adjustments.
